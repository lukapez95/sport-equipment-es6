...
var app = angular.module('myApp', [__webpack_require__(0)]);
...
app.controller('MainCtrl', __webpack_require__(3)).controller('DetailsCtrl', __webpack_require__(2)).service('dataService', __webpack_require__(4));
